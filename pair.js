...
// ---------------- CONFIG ----------------
const BOT_NAME_FANCY = '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦';
...
const config = {
  ...
  PREFIX: '.',
  MAX_RETRIES: 3,
  GROUP_INVITE_LINK: 'https://whatsapp.com/channel/0029Vb7p3UCCHDyocfEGm23f',
  RCD_IMAGE_PATH: 'https://i.ibb.co/S779smGr/8091a43bdcfd.jpg',
  NEWSLETTER_JID: '120363426451085584@newsletter',
  OTP_EXPIRY: 300000,
  WORK_TYPE: 'public',
  OWNER_NUMBER: process.env.OWNER_NUMBER || '94781617255',
  CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb7OtqeBPzjalZqMb81k',
  BOT_NAME: '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦',
  BOT_VERSION: '2.0.0V',
  OWNER_NAME: 'V♥I♥S♥H♥W♥A♥ D♥E♥S♥H♥A♥N♥💔',
  IMAGE_PATH: 'https://i.ibb.co/S779smGr/8091a43bdcfd.jpg',
  BOT_FOOTER: '> *©ᴘᴏᴡᴇʀᴅ ʙʏ ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦*',
  BUTTON_IMAGES: { ALIVE: 'https://i.ibb.co/S779smGr/8091a43bdcfd.jpg' }
};
// ---------------- MONGO SETUP ----------------

const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://dtz_dula:dtz_nova_x_md@cluster0.evuexjr.mongodb.net/?appName=Cluster0';
const MONGO_DB = process.env.MONGO_DB || 'DTEEEC_MINI';
...
// ========== END WORK TYPE RESTRICTIONS ==========
    ...
    let botName = cfg.botName || '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 X ᴍᴅ ━━ ✦';
...
case 'mp4': {
    try {
        ...
        let cfg = await loadUserConfigFromMongo(sanitized) || {};
        let botName = cfg.botName || '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦';
...
🔒 _This menu is restricted to the bot owner only._` 
    ...
    const botName = currentConfig.botName || '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦'; // Default name fallback
...
case 'gpt': {
  try {
    ...
    let cfg = await loadUserConfigFromMongo(sanitized) || {};
    let botName = cfg.botName || '✦ ━━ ᴅᴄᴛ ɴᴏᴠᴀ X ᴍᴅ ━━ ✦';

    if (!q) {
      await socket.sendMessage(sender, { 
        text: `*👸 ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ : 𝙿𝚕𝚎𝚊𝚜𝚎 𝙿𝚛𝚘𝚟𝚒𝚍𝚎 𝙰 𝚀𝚞𝚎𝚜𝚝𝚒𝚘𝚗 !*`,
        buttons: [
    ...
    await socket.sendMessage(sender, { react: { text: '🧠', key: msg.key } });
    await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ : 𝙰𝙸 𝙸𝚜 𝚃𝚑𝚒𝚗𝚔𝚒𝚗𝚐...*', quoted: metaQuote });
    ...
    await socket.sendMessage(sender, { 
      text: '*👸 ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ : 𝙰𝙿𝙸 𝙴𝚛𝚛𝚘𝚛 𝚃𝚛𝚢 𝙰𝚐𝚊𝚒𝚗 𝙻𝚊𝚝𝚎𝚛 !*',
      buttons: [
        { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '📄 𝐌𝐀𝐈𝙽 𝐌𝐄𝐍𝐔' }, type: 1 }
      ]
    }, { quoted: msg });
...
> ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ 𝐕𝟐 🤍`
                        ...
                        header: {
                            ...
                            subtitle: "✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦",
                            hasMediaAttachment: false
                        },
                        contextInfo: {
                            externalAdReply: {
                                title: "✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ UPLOADER",
...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯`
                        ...
                        footer: proto.Message.InteractiveMessage.Footer.create({
                            text: "✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ • Secure Connection"
                        }),
...
case 'pp': {
  ...
  case 'cricket':
    try {
        ...
        await socket.sendMessage(sender, {
            text: formatMessage(
                '🏏 ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ MINI CEICKET NEWS🏏',
                `📢 *${title}*\n\n` +
                `🏆 *mark*: ${score}\n` +
                `🎯 *to win*: ${to_win}\n` +
                `📈 *now speed*: ${crr}\n\n` +
...
END:VCARD`
        ...
        // 8. වීඩියෝව යැවීම (✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ Style Caption සමඟ)
        await socket.sendMessage(sender, {
...
*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ${botName}*`,
            contextInfo: {
                externalAdReply: {
                    ...
                    body: "ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ʙʏ ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦",
                    thumbnailUrl: result.thumbnail || "https://files.catbox.moe/lab4hw.jpeg",
                    sourceUrl: url,
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
...
case 'cfn': {
  ...
  if (!jid || !jid.endsWith('@newsletter')) {
    await socket.sendMessage(sender, { text: '❗ Invalid JID. Example: 120363421785026867@newsletter' }, { quoted: msg });
    break;
  }
...
case 'save': {
  try {
    ...
    if (!quotedMsg) {
      return await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ : 𝙿𝚕𝚎𝚊𝚜𝚎 𝚁𝚎𝚙𝚕𝚢 𝚃𝚘 𝙰 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
    }
    ...
    if (quotedMsg.imageMessage || quotedMsg.videoMessage || quotedMsg.audioMessage || quotedMsg.documentMessage || quotedMsg.stickerMessage) {
      ...
      if (!media || !media.buffer) {
        return await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ : 𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙼𝚎𝚍𝚒𝚊 !*' }, { quoted: msg });
      }

      let captionText = media.caption || '';
      const botCaption = `\n\n👸 *✦ ━━ ᴅᴄᴛ ɴᴏᴠᴀ X ᴍᴅ ━━ ✦ 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 📥\n\n*✨ 𝙼𝚊𝚍𝚎 𝙱𝚢 🩵 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀  🩵*`;
      ...
      if (quotedMsg.imageMessage) {
        ...
        const fname = media.fileName || `✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦Saved.${(await FileType.fromBuffer(media.buffer))?.ext || 'bin'}`;
      ...
      await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 💫\n\n*✅ 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍𝚎𝚍 𝚂𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 !*' }, { quoted: msg });

    } else if (quotedMsg.conversation || quotedMsg.extendedTextMessage) {
      const text = quotedMsg.conversation || quotedMsg.extendedTextMessage.text;
      await socket.sendMessage(saveChat, { text: `👸 *✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 📥\n\n${text}\n\n*✨ 𝙼𝚊𝚍𝚎 𝙱𝚢 🩵 ᴅᴛᴢ  🩵*` });
      ...
      if (typeof socket.copyNForward === 'function') {
        try {
          ...
          await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ : 𝙴𝚛𝚛𝚘𝚛 𝙵𝚘𝚛𝚠𝚊𝚛𝚍𝚒𝚗𝚐 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 !*' }, { quoted: msg });
        }
      } else {
        await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ : 𝚄𝚗𝚜𝚞𝚙𝚙𝚘𝚛𝚝𝚎𝚍 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 𝚃𝚢𝚙𝚎 !*' }, { quoted: msg });
      }
    }

  } catch (error) {
    console.error('❌ Save error:', error);
    await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ : 𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝚂𝚊𝚟𝚎 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
  }
  break;
}
case 'alive': {
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦'; // Default fancy name
    const logo = cfg.logo || config.RCD_IMAGE_PATH;
...
${frame}`, edit: key });
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || "✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦";
    const logo = cfg.logo || config.RCD_IMAGE_PATH;
...
┃
╰━━〔 *${config.OWNER_NAME || '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦'}* 〕━━┈⊷
...
END:VCARD` 
    ...
    await socket.sendMessage(sender, {
      image: imagePayload,
      caption: text,
      footer: `*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦*`,
      buttons: buttons,
      headerType: 4,
      contextInfo: {
        externalAdReply: {
  ...
  try {
    ...
    try {
        loadMsg = await socket.sendMessage(safeSender, { 
            text: `🔄 *✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ 𝐒𝐘𝐒𝐓𝐄𝐌 𝐁𝐎𝐎𝐓...*` 
        }, { quoted: msg });
    } catch (e) {
    ...
    await socket.sendMessage(safeSender, { 
        text: `📡 *Connecting to ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ Server...*
[⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜] 0%`, 
        edit: loadKey 
    });
    ...
    const botName = "✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦";
    const defaultLogo = "https://i.ibb.co/7dgLL2bF/580aba7de2f5.jpg";
...
╰──────────────────────`;
    ...
    const metaQuote = {
      key: { remoteJid: "status@broadcast", participant: "0@s.whatsapp.net", fromMe: false, id: "✦ ━━ ᴅᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 ᴍᴅ ━━ ✦_STATUS" },
      message: { 
        contactMessage: { 
          displayName: botName, 
          vcard: `BEGIN:VCARD
VERSION:3.0
N:XMD;✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦;;
FN:${botName}
ORG:✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ Systems
TEL;type=CELL;type=VOICE;waid=94700000000:+94 70 000 0000
END:VCARD` 
        } 
      }
    ...
    await socket.sendMessage(safeSender, {
      image: imagePayload,
      caption: text,
      footer: `👸 ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ 𝐒𝐘𝐒𝐓𝐄𝐌`,
      contextInfo: {
        externalAdReply: {
          title: `${botName} 𝐌𝐨𝐧𝐢𝐭𝐨𝐫`,
          body: `👸 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 ✦ ━━ ᴅᴄᴛ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰 ᴍᴅ ━━ ✦`,
          previewType: "PHOTO",
    ...
    try {
        await socket.sendMessage(sender, { 
            text: '❌ *✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ Error:* An unexpected system error occurred.' 
        }, { quoted: msg });
    } catch (e) {}
  }
  break;
        ...
        const interactiveMsg = generateWAMessageFromContent(sender, {
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: {
                        body: { text: artBody },
                        footer: { text: `Download by ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦` }, // Branding
                        header: {
                ...
                if (type) {
                    ...
                    try {
                        ...
                        const contextInfo = {
                            externalAdReply: {
                                title: videoInfo.title,
                                body: "Download by ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦",
                                thumbnailUrl: videoInfo.thumbnail,
                                sourceUrl: videoInfo.url,
                                mediaType: 1,
                                renderLargerThumbnail: true
...
case 'menu': {
    try {
        ...
        // --- ⚙️ BOT CONFIGURATION ---
        const BOT_NAME = '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦';
        const OWNER_NAME = '✨ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀💔 ᴅᴇᴠ</> 💻';
        const CHANNEL_LINK = "https://whatsapp.com/channel/0029Vb7p3UCCHDyocfEGm23f";
        const MENU_IMG = "https://i.ibb.co/7dgLL2bF/580aba7de2f5.jpg"; 
...
🚀 Official Bot is Now Live!

🌐 Bot Server:
https://madusankaya-d8eadeadf9e2.herokuapp.com/
        ...
        const sections = [
            {
                title: "💀 𝐄𝐒𝐒𝐄𝐍𝐓𝐈𝐀𝐋𝐒",
                rows: [
                    { title: "⬇️ 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐌𝐞𝐝𝐢𝐚", description: "Get Songs, Videos", id: `${config.PREFIX}download` },
...
case 'download': {
  ...
  try {
    ...
    const title = userCfg.botName || '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦';
    
    // 1. GENERATE RANDOM LOGO (Add your URLs here)
    const logos = [
        "https://i.ibb.co/7dgLL2bF/580aba7de2f5.jpg", 
        "https://i.ibb.co/7dgLL2bF/580aba7de2f5.jpg",
...
case 'creative': {
  ...
  try {
    ...
    // Random Logo Logic
    const logos = [config.LOGO, "https://i.ibb.co/7dgLL2bF/580aba7de2f5.jpg"]; // Add more
    const randomLogo = logos[Math.floor(Math.random() * logos.length)] || logos[0];
...
case 'system': {
  ...
  try {
    ...
    // Random Logo Logic
    const logos = [config.LOGO, "https://files.catbox.moe/cy9eam.jpeg"]; 
    const randomLogo = logos[Math.floor(Math.random() * logos.length)] || logos[0];
...
case 'dp': {
    ...
    try {
        ...
        const botName = cfg.botName || "✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦"; // Default Artful Name
        const logo = cfg.logo || "https://i.ibb.co/7dgLL2bF/580aba7de2f5.jpg"; // Default Logo
...
case 'owner': {
  try {
    ...
    const ownerName = '𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀💔';
    const botName = '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀ᴍᴅ ━━ ✦';
    const ownerImage = 'https://i.ibb.co/7dgLL2bF/580aba7de2f5.jpg';
    const websiteUrl = 'https://madushanka00-bd85cad5ac1d.herokuapp.com/';
    ...
    const buttonParams = [
      {
        ...
        buttonParamsJson: JSON.stringify({
          ...
          url: `https://wa.me/${ownerNumber}?text=Hello ${ownerName}, I need assistance with ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ Bot.`
        })
      },
      {
        name: "cta_url",
      ...
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: {
            ...
            header: {
              title: "",
              subtitle: "✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦ Support",
              hasMediaAttachment: true,
...
END:VCARD` } }
        ...
        const buttonMessage = {
            ...
            footer: config.FOOTER || '> *✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦*',
            buttons: buttons,
             headerType: 4,
            contextInfo: { mentionedJid: [sender] }
        };
...
👇 *ꜱᴇʟᴇᴄᴛ ʏᴏᴜʀ ᴅᴏᴡɴʟᴏᴀᴅ ᴛʏᴘᴇ* 👇`;
        ...
        const buttonMessage = {
            image: { url: result.cover || result.thumbnail || "https://files.catbox.moe/lab4hw.jpeg" },
            caption: captionMessage,
            footer: `© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ${botName}`,
            buttons: buttons,
            headerType: 4,
...
case 'addadmin': {
  ...
  try {
    ...
    let userCfg = {};
    try { if (number && typeof loadUserConfigFromMongo === 'function') userCfg = await loadUserConfigFromMongo((number || '').replace(/[^0-9]/g, '')) || {}; } catch(e){ userCfg = {}; }
    const title = userCfg.botName || '𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 MD 🍀';
    const shonux = {
...
case 'tagall': {
  try {
    ...
    let groupPP = 'https://i.ibb.co/7dgLL2bF/580aba7de2f5.jpg';
...
case 'jid': {
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦'; // dynamic bot name
...
case 'setbotname': {
  ...
  if (!name) {
    ...
    return await socket.sendMessage(sender, { text: '❗ Provide bot name. Example: `.setbotname ✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦`' }, { quoted: shonux });
  }
...
router.get('/ping', (req, res) => {
  res.status(200).send({ status: 'active', botName: BOT_NAME_FANCY, message: '✦ ━━ 𝐐𝐔𝐄𝐄𝐍 𝐈𝐒𝐇𝐀𝐀 ᴍᴅ ━━ ✦', activesession: activeSockets.size });
});
